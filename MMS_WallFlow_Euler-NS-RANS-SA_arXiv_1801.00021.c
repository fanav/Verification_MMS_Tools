...
/* REFERENCE:
https://arxiv.org/abs/1801.00021
*/
...
//                              Euler CASES                                     //
    ...
    // MS-1: EULER Verification case, slip wall-bounded curved domain
    case 1:  qnt = MS_1(qnt_type,qnt_id,x,y); break;
    
    
//                          Navier-Stokes CASES                                 //    
    
    // MS-2: Navier-Stokes Verification case, no-slip wall-bounded curved domain
    case 2:  qnt = MS_2(qnt_type,qnt_id,x,y); break;     
    
                        
//                            RANS-SA CASES                                    // 

    // MS-3: Realistic RANS-SA Verification case, Eça et al. (2007)
    case 3:  qnt = MS_3(qnt_type,qnt_id,x,y); break;        

    // MS-4: Realistic RANS-SA Verification case, Oliver et al. (2012)
